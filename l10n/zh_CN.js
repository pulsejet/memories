OC.L10N.register(
    ...
    "Show photo owner name on timeline" : "在时间轴上显示照片所有者名称",
    "Autoplay Live Photos" : "自动播放实况照片",
    "Loop Live Photos" : "自动循环实况照片",
    "Loop Videos" : "循环影片",
    ...
    "Day range (1-7)" : "日范围 (1-7)",
    "Number of days before and after each anniversary to include" : "每个周年纪念日之前与之后应包含的天数",
    "Photos per year (1-50)" : "每年的照片数 (1-50)",
    "Maximum number of photos to include per year" : "每年最多可包含的照片数量",
    "Info" : "信息",
    "Close" : "关闭",
    ...
    "Upload not permitted" : "不允许上传",
    "_Skipped {n} file that already exists_::_Skipped {n} files that already exist_" : ["忽略 {n} 个已有的文件"],
    "Uploading {file} ({current}/{total})" : "正在上传 {file} ({current}/{total})",
    "Upload failed" : "上传失败",
    "_Successfully uploaded {n} file_::_Successfully uploaded {n} files_" : ["成功上传 {n} 个文件"],
    "Uploaded {success} files, {failed} failed" : "已上传 {success} 个文件，失败 {failed} 个",
    "_Failed to upload {n} file_::_Failed to upload {n} files_" : ["上传 {n} 个文件失败"],
    ...
    "Shared Album" : "已分享相册",
    "Setup" : "安装",
    "Failed to add {filename} to album." : "新增 {filename} 至相册失败。",
