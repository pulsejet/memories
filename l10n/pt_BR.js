OC.L10N.register(
    ...
    "Photos" : "Fotos",
    "Upload Local" : "Enviar arquivo local",
    "Delete" : "Excluir",
    ...
    "Slideshow Duration (1-60 seconds)" : "Duração da apresentação de slides (1 a 60 segundos)",
    ...
    "Day range (0-7)" : "Intervalo de dias (0-7)",
    "Number of days before and after each anniversary" : "Número de dias antes e depois de cada aniversário",
    "Photos per year (1-50)" : "Fotos por ano (1-50)",
    "Maximum number of photos to include per year" : "Número máximo de fotos a serem incluídas por ano",
    "Info" : "Informação",
    "Close" : "Fechar",
    ...
    "You can optionally exclude specific folder names from being indexed." : "Opcionalmente, você pode excluir nomes de pastas específicas da indexação.",
    "Excluded folder names (comma-separated)" : "Nomes de pastas excluídas (separados por vírgulas)",
    ...
    "You are using SQLite, which is not recommended for performance." : "Você está usando o SQLite, o que não é recomendado por questões de desempenho.",
    "innodb_buffer_pool_size is set to {size} GiB (minimum recommended: {minimum} GiB)." : "innodb_buffer_pool_size está definido como {size} GiB (mínimo recomendado: {minimum} GiB).",
    ...
    "Memories supports offline reverse geocoding using OpenStreetMap data on MySQL and Postgres." : "O Memórias oferece suporte à geocodificação reversa off-line utilizando dados do OpenStreetMap no MySQL e no Postgres.",
    ...
    "Location search endpoint for metadata editor" : "Ponto final de pesquisa de localização para o editor de metadados",
    ...
    "VA-API device path" : "Caminho do dispositivo VA-API",
    ...
    "Connection addresses (comma separated)" : "Endereços de conexão (separados por vírgulas)",
    ...
    "Find photos matching “{query}”" : "Encontre fotos que correspondam a “{query}”",
    ...
    "Failed to search for location." : "Falha ao pesquisar a localização.",
    "Reset" : "Redefinir",
    ...
    "_Failed to load metadata for {n} photo._::_Failed to load metadata for {n} photos._" : ["Não foi possível carregar os metadados de {n} foto.","Não foi possível carregar os metadados de {n} de fotos.","Não foi possível carregar os metadados de {n} fotos."],
    "_{n} photo cannot be edited (permissions error)._::_{n} photos cannot be edited (permissions error)._" : ["Não é possível editar {n} foto (erro de permissão).","Não é possível editar {n} de fotos (erro de permissão).","Não é possível editar {n} fotos (erro de permissão)."],
    "Date / Time" : "Data / Hora",
    ...
    "You can only merge with a named person" : "Você só pode mesclar com uma pessoa com nome",
    ...
    "Failed to download file for sharing" : "Falha ao baixar o arquivo para compartilhar",
    ...
    "_Skipped {n} file that already exists_::_Skipped {n} files that already exist_" : ["Ignorou {n} arquivo que já existe","Ignorou {n} de arquivos que já existem","Ignorou {n} arquivos que já existem"],
    "Uploading {file} ({current}/{total})" : "Enviando {file} ({current}/{total})",
    "Upload failed" : "Falha no upload",
    "_Successfully uploaded {n} file_::_Successfully uploaded {n} files_" : ["{n} arquivo carregado com sucesso","{n} de arquivos carregados com sucesso","{n} arquivos carregados com sucesso"],
    "Uploaded {success} files, {failed} failed" : "{success} arquivos enviados, {failed} falharam",
    "_Failed to upload {n} file_::_Failed to upload {n} files_" : ["Falha ao carregar {n} arquivo","Falha ao carregar {n} de arquivos","Falha ao carregar {n} arquivos"],
    ...
    "{srv} - Healthy ({version})." : "{srv} - Saudável ({version}).",
    "{srv} - Unhealthy ({info})." : "{srv} - Não saudável ({info}).",
    "Save as" : "Salvar como",
    ...
    "_You are about to download {count} item._::_You are about to download {count} items._" : ["Você está prestes a baixar {count} item.","Você está prestes a baixar {count} de itens.","Você está prestes a baixar {count} itens."],
    "_You are about to move {count} item._::_You are about to move {count} items._" : ["Você está prestes a mover {count} item.","Você está prestes a mover {count} de itens.","Você está prestes a mover {count} itens."]
},
