OC.L10N.register(
    ...
    "You are about to download a large number of files." : "Você está prestes a baixar um grande número de arquivos.",
    "Continue" : "Continuar",
    "You are about to delete a large number of files" : "Você está prestes a baixar um grande número de arquivos.",
    "Failed to delete files" : "Falha ao excluir arquivos",
    "Move" : "Mover",
    "You are about to move a large number of files" : "Você está prestes a mover um grande número de arquivos",
    ...
    "Only user \"{user}\" can delete this album" : "Somente o usuário \"{user}\" pode excluir este álbum",
