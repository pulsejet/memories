OC.L10N.register(
    ...
    "Some drivers (e.g. AMD and older Intel) do not support hardware accelerated rotation. You can attempt to force software-based transpose in this case." : "Alguns drivers (por exemplo, AMD e Intel mais antigos) não suportam rotação acelerada por hardware. Você pode tentar forçar a transposição baseada em software neste caso.",
