OC.L10N.register(
    ...
    "Set as cover image" : "Angi som forsidebilde",
    ...
    "Database triggers are set up correctly." : "Databaseutløsere er satt opp riktig.",
    "Database triggers not set up; {m} mode in use." : "Databaseutløsere er ikke satt opp; {m} modus er i bruk.",
    "See the documentation for information on how to resolve this." : "Se dokumentasjonen for informasjon om hvordan du løser dette.",
    "Performance" : "Ytelse",
    "Unknown" : "Ukjent",
    ...
    "Search your photos …" : "Søk i bildene dine...",
    "Start typing to find photos and albums" : "Begynn å skrive for å finne bilder og album",
    ...
    "Create a new face with this name?" : "Opprette et nytt ansikt med dette navnet?",
    "Create new face" : "Opprett nytt ansikt",
    ...
    "Destination path" : "Destinasjonsbane",
    "Add to albums" : "Legg til i album",
    "Add tags" : "Legg til merker",
    "Attach collaborative tags to all uploads" : "Legg ved samarbeidsmerker i alle opplastinger",
    "No albums selected" : "Ingen album valgt",
    "Choose the destination folder for the upload" : "Velg målmappen for opplastingen",
    "Creating tags" : "Oppretter merker",
    "Uploading {file}" : "Laster opp {file}",
    "Failed to upload {file}" : "Opplasting av {file} feilet",
    "Adding files to album {album}" : "Legger til filer i album {album}",
    "Attaching tags to {file}" : "Legger ved merker til {file}",
