OC.L10N.register(
    ...
    "Show photo owner name on timeline" : "Прикажи власника фотографије на временској линији",
    "Autoplay Live Photos" : "Аутоприказ Live Photo",
    "Loop Live Photos" : "Приказуј у круг фотографије уживо",
    ...
    "Setup" : "Подеси",
    "Failed to add {filename} to album." : "{filename} не може да се дода у албум.",
    "Failed to remove {filename}." : "Није успело уклањање {filename}.",
    "Failed to create {albumName}." : "{albumName} није могао да се креира.",
    "Failed to update properties of {albumName} with {properties}." : "Није успело ажурирање особина {albumName} са {properties}",
    ...
    "Failed to remove {filename} from face." : "Није успело уклањање {filename} из лица.",
    "Failed to move {filename} from face." : "Није успело премештање {filename} из лица.",
    ...
    "Cover image set successfully" : "Успешно је постављена слика омота",
    "Failed to set cover image" : "Није успело постављање слике омота",
