OC.L10N.register(
    ...
    "Show hidden folders" : "Toon verborgen mappen",
    "Sort folders oldest-first" : "Sorteer mappen oudste-eerst",
    "Sort albums oldest-first" : "Sorteer albums oudste-eerst",
    "Show hidden albums" : "Toon verborgen albums",
    "Info" : "Info",
    "Close" : "Sluit",
    "{photoCount} photos" : "{photoCount} foto's",
    "Failed to load some photos" : "Kon sommige foto's niet laden",
    "Failed to update setting" : "Kon instellingen niet bijwerken",
    "Recommended Apps" : "Aanbevolen Apps",
    "Albums support is enabled through the Photos app." : "Album ondersteuning wordt geactiveerd door de Foto's app.",
    "Albums are disabled because the Photos app is not available." : "Albums zijn inactief omdat de Foto's app niet beschikbaar is",
    "File Support" : "Bestandsondersteuning",
    "Images (JPEG, PNG, GIF, BMP)" : "Afbeeldingen (JPEG, PNG, GIF, BMP)",
    "HEIC (Imagick)" : "HEIC (Imagick)",
    "TIFF (Imagick)" : "TIFF (Imagick)",
    "Videos (ffmpeg)" : "Videos (ffmpeg)",
    "Imaginary (not recommended)" : "Imaginary (niet aanbevolen)",
    "Documentation." : "Documentatie",
    "PHP-Imagick is available [{version}]." : "PHP-Imagick is beschikbaar [{version}].",
    "PHP-Imagick is not available." : "PHP-Imagick is niet beschikbaar.",
