OC.L10N.register(
    ...
    "Info" : "Info",
    "Close" : "Tutup",
    "{photoCount} photos" : "{photoCount} foto",
    ...
    "Failed to delete {name}." : "Gagal menghapus {name}.",
    "Save" : "Simpan",
    ...
    "Failed to rename {oldName} to {name}." : "Gagal mengubah nama {oldName} to {name}.",
    ...
    "Undo" : "Undo",
    "Redo" : "Ulang lagi",
    "Show original image" : "Tampilkan citra asli",
    "Zoom in" : "Perbesar",
    "Zoom out" : "Perkecil",
