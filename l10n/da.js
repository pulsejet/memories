OC.L10N.register(
    ...
    "Remove {collaboratorLabel} from the collaborators list" : "Fjern {samarbejdspartner Etiket} fra listen over samarbejdspartnere",
    ...
    "Share via public link" : "Andel via offentlig forbindelse",
    ...
    "Name" : "Navn",
    "Update" : "Opdater",
    "Failed to rename {oldName} to {name}." : "Kunne ikke omdøbe {old Name} til {name}.",
    "Loading …" : "Indlæser ...",
    "Move" : "Flyt",
    ...
    "Unassigned faces" : "Ikke-tildelte flader",
    ...
    "Auto" : "Auto",
    "Setup" : "Opsætning",
    "Failed to rename {currentAlbumName} to {newAlbumName}." : "Kunne ikke omdøbe {old Name} til {newAlbumName}.",
