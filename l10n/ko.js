OC.L10N.register(
    ...
    "Imaginary (not recommended)" : "Imaginary (비권장)",
    ...
    "You can optionally use a regular expression to exclude matching paths from being indexed." : "정규 표현식을 사용하여 일치하는 경로가 인덱스되지 않도록 할 수 있습니다.",
    "For example, to exclude special QNAP folders:" : "예를 들어 특정한 QNAP 폴더를 제외하려면:",
    "Or, exclude all files starting with \"private-\" or \"backup-\":" : "또한, \"private-\"나 \"backup-\"으로 시작하는 파일을 제외하려면:",
    "You can use the regex101 website to validate and test the pattern:" : "regex101에서 패턴을 확인하고 시험할 수 있습니다.",
    "Exclude paths matching regular expression" : "정규 표현식에 일치하는 경로를 제외",
    ...
    "Database triggers are set up correctly." : "데이터베이스 트리거가 올바르게 설정되었습니다.",
    "Database triggers not set up; {m} mode in use." : "데이터베이스 트리거가 설정되지 않음: {m} 모드 사용중.",
    "See the documentation for information on how to resolve this." : "해결 방법을 찾기 위한 정보에 관해서는 문서를 참조하세요.",
    ...
    "Some drivers (e.g. AMD and older Intel) do not support hardware accelerated rotation. You can attempt to force software-based transpose in this case." : "일부 드라이버(예: AMD 및 구형 Intel)는 하드웨어 가속 회전을 지원하지 않습니다. 그럴 땐 소프트웨어 기반 변형을 강제하도록 시도할 수 있습니다.",
    ...
    "Force transpose in software" : "소프트웨어 변형 강제",
    ...
    "Template" : "템플릿",
    "Shared" : "공유됨",
    "Search your photos …" : "사진 검색...",
    "Start typing to find photos and albums" : "입력하여 사진 및 앨범 찾기",
    ...
    "You can only merge with a person with name" : "이름이 있는 사람과 합칠 수 있습니다.",
    ...
    "Move left" : "왼쪽으로 이동",
    "Move right" : "오른쪽으로 이동",
    "Unidentified location" : "알 수 없는 위치",
    "Files without location" : "위치가 없는 파일",
    "Image saved successfully" : "이미지를 성공적으로 저장했습니다.",
    "Error saving image: {error}" : "파일 저장 오류: {error}",
