OC.L10N.register(
    ...
    "Info" : "Upplýsingar",
    "Close" : "Loka",
    "{photoCount} photos" : "{photoCount} ljósmyndir",
    "Performance" : "Afköst",
    "Unknown" : "Óþekkt",
    ...
    "Failed to delete {name}." : "Tókst ekki að eyða {name}.",
    "Save" : "Vista",
    ...
    "Failed to rename {oldName} to {name}." : "Mistókst að endurnefna {oldName} sem {name}.",
