OC.L10N.register(
    ...
    "Photos" : "Grianghraif",
    "Upload Local" : "Uaslódáil go háitiúil",
    "Delete" : "Scrios",
    ...
    "Slideshow Duration (1-60 seconds)" : "Fad an Taispeántais Sleamhnán (1-60 soicind)",
    ...
    "Day range (1-7)" : "Raon lae (1-7)",
    "Number of days before and after each anniversary" : "Líon na laethanta roimh gach comóradh agus ina dhiaidh",
    "Photos per year (1-50)" : "Grianghraif in aghaidh na bliana (1-50)",
    "Maximum number of photos to include per year" : "Uasmhéid na ngrianghraf le cur san áireamh in aghaidh na bliana",
    "Info" : "Eolas",
    "Close" : "Dún",
    ...
    "Memories supports offline reverse geocoding using OpenStreetMap data on MySQL and Postgres." : "Tacaíonn Memories le geochódú inbhéartach as líne ag baint úsáide as sonraí OpenStreetMap ar MySQL agus Postgres.",
    ...
    "Location search endpoint for metadata editor" : "Críochphointe cuardaigh suímh don eagarthóir meiteashonraí",
    ...
    "VA-API device path" : "Conair gléis VA-API",
    ...
    "Connection addresses (comma separated)" : "Seoltaí ceangail (scartha le camóga)",
    ...
    "Empty" : "Folamh",
    "Unchanged" : "Gan athrú",
    "Failed to search for location." : "Theip ar an gcuardach don suíomh.",
    "Reset" : "Athshocraigh",
    ...
    "Failed to download file for sharing" : "Theip ar íoslódáil an chomhaid lena roinnt",
    ...
    "{srv} - Healthy ({version})." : "{srv} - Sláintiúil ({version}).",
    "{srv} - Unhealthy ({info})." : "{srv} - Neamhshláintiúil ({info}).",
    "Save as" : "Sábháil mar",
