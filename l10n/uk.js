OC.L10N.register(
    ...
    "Attaching tags to {file}" : "Прикріплення тегів до {file}",
    "Failed to attach tags to {file}" : "Не вдалося прикріпити теги до {file}",
    ...
    "Attach collaborative tags to all uploads" : "Додайте теги для спільної роботи до всіх завантажень",
