OC.L10N.register(
    ...
    "Photos" : "Світлини",
    "Delete" : "Вилучити",
    "Remove from album" : "Вилучити з альбому",
    ...
    "Set as cover image" : "Встановити як обкладинку",
    "Move to folder" : "Перемістити до каталогу",
    "Add to album" : "Додати в альбом",
    "Move to person" : "Перейдіть до особи",
    "Remove from person" : "Видалити з особи",
    ...
    "De-duplicate identical files" : "Видалення дублікатів однакових файлів",
    "Show photo owner name on timeline" : "Показувати ім'я власника фото на часовій шкалі",
    "Autoplay Live Photos" : "Автовідтворення \"живих\" світлин",
    "Loop Live Photos" : "Петля живих фотографій",
    "Show full file path in sidebar" : "Показати повний шлях до файлу в бічній панелі",
    "Show metadata in slideshow" : "Показати метадані в слайд-шоу",
    ...
    "Albums support is enabled through the Photos app." : "Підтримка альбомів вмикається через застосунок \"Світлини\".",
    "Albums are disabled because the Photos app is not available." : "Альбоми вимкнено, оскільки застосунок \"Світлини\" недоступний.",
    "Recognize is installed and enabled for face recognition." : "Для розпізнавання облич встановлено та увімкнено застосунок \"Розпізнавання\".",
    "Recognize is installed but not enabled for face recognition." : "Застосунок \"Розпізнавання\" встановлено, але не увімкнено для розпізнавання облич.",
    "Recognize is not installed. Face recognition and object tagging may be unavailable." : "Застосунок \"Розпізнавання\" не встановлено. Функції розпізнавання облич та позначення об'єктів можуть бути недоступні.",
    ...
    "Imaginary (not recommended)" : "Уявний (не рекомендується)",
    ...
    "Imaginary is enabled for preview generation. This will override other preview providers. We currently recommend against using Imaginary due to multiple bugs in handling of HEIC and GIF files." : "Imaginary увімкнено для створення попереднього перегляду. Це замінить інші засоби попереднього перегляду. Наразі ми не рекомендуємо використовувати Imaginary через численні помилки в обробці файлів HEIC та GIF.",
    ...
    "Memories is a completely free and open source app under active development." : "Memories - безкоштовний застосунок з відкритим вихідним кодом, який перебуває в активній розробці.",
    ...
    "{n} media files failed indexing and were skipped." : "{n} медіафайли не пройшли індексацію і були пропущені.",
    "View failure logs." : "Перегляд журналів збоїв.",
    "Files that failed indexing will not be indexed again unless they change." : "Файли, індексація яких не вдалася, не будуть індексуватися знову, якщо вони не зміняться.",
    "You can manually retry files that failed indexing." : "Ви можете вручну повторити спробу індексації файлів, які не вдалося проіндексувати.",
    ...
    "You can optionally use a regular expression to exclude matching paths from being indexed." : "Ви можете за бажанням використовувати регулярний вираз, щоб виключити відповідні шляхи з індексації.",
    "For example, to exclude special QNAP folders:" : "Наприклад, виключити спеціальні папки QNAP:",
    "Or, exclude all files starting with \"private-\" or \"backup-\":" : "Або вилучіть усі файли, що починаються з \"private-\" або \"backup-\":",
    "You can use the regex101 website to validate and test the pattern:" : "Ви можете використовувати веб-сайт regex101 для перевірки та тестування шаблону:",
    "Exclude paths matching regular expression" : "Виключити шляхи, що відповідають регулярному виразу",
    ...
    "Database triggers are set up correctly." : "Тригери бази даних налаштовані правильно.",
    "Database triggers not set up; {m} mode in use." : "Тригери бази даних не налаштовані; використовується режим {m}.",
    "See the documentation for information on how to resolve this." : "Інформацію про те, як вирішити цю проблему, див. у документації.",
    ...
    "Download planet database" : "Звантажити базу даних планети",
    "Continue" : "Продовжити",
    ...
    "You need to download the planet data into your database. This is highly recommended and has low overhead." : "Вам потрібно звантажити дані про планету до вашої базу даних. Наполегливо рекомендується, має прийнятну вартість.",
    ...
    "HW Acceleration" : "Прискорення ГВП",
    "VA-API device ({dev}) is readable" : "Пристрій VA-API ({dev}) читається",
    ...
    "Some drivers (e.g. AMD and older Intel) do not support hardware accelerated rotation. You can attempt to force software-based transpose in this case." : "Деякі драйвери (наприклад, AMD і старі Intel) не підтримують апаратне прискорення обертання. У цьому випадку можна спробувати примусово застосувати програмне перенесення.",
    ...
    "Enable streaming transpose workaround" : "Увімкнути обхідний шлях транспонування потоку",
    "Force transpose in software" : "Транспонування сили в програмному забезпеченні",
    ...
    "Enable streaming GOP size workaround" : "Увімкнути обхідний шлях для потокового розміру GOP",
    ...
    "Binary path (local only)" : "Двійковий шлях (тільки локально)",
    "Bind address (local only)" : "Прив'язати адресу (тільки локальну)",
    "Connection address (same as bind if local)" : "Адреса з'єднання (така ж, як і bind, якщо локальна)",
    "Quality Factor (15 - 45) (default 25)" : "Фактор якості (15 - 45) (за замовчуванням 25)",
    "Default high resolution image loading behavior of the photo viewer." : "Типова поведінка завантаження зображень у програмі для перегляду фотографій у високій роздільній здатності.",
    ...
    "Template" : "Шаблон",
    "Shared" : "Спільне",
    "Search your photos …" : "Шукайте свої фотографії ...",
    "Start typing to find photos and albums" : "Почніть вводити, щоб знайти фотографії та альбоми",
    ...
    "Failed to delete {name}." : "Не вдалося вилучити {name}.",
    "Remove Album" : "Вилучити альбом",
    "Leave Album" : "Залишити альбом",
    "Are you sure you want to permanently remove album \"{name}\"?" : "Дійсно вилучити альбом \"{name}\"?",
    ...
    "Cannot edit rotation on videos ({name})" : "Неможливо редагувати ротацію на відео ({name})",
    "Cannot edit rotation on Live Photos ({name})" : "Неможливо редагувати обертання на живих фотографіях ({name})",
    ...
    "Orientation (EXIF)" : "Орієнтація (EXIF)",
    "This feature rotates images losslessly by updating the EXIF metadata. This approach is known to sometimes not work correctly on certain image types such as HEIC. Make sure you do a test run before using it on multiple images." : "Ця функція обертає зображення без втрати якості, оновлюючи метадані EXIF. Відомо, що цей підхід іноді не працює коректно з певними типами зображень, такими як HEIC. Перед використанням цієї функції для декількох зображень обов'язково проведіть тестове запускання.",
    "Rotate Left" : "Повернути ліворуч",
    "Rotate Right" : "Повернути праворуч",
    "Flip" : "Переверни.",
    "Only user \"{user}\" can delete this person" : "Тільки користувач \"{user}\" може вилучити цю особу",
    "Remove person" : "Вилучити особу",
    "Are you sure you want to remove {name}?" : "Дійсно вилучити {name}?",
    "Failed to rename {oldName} to {name}." : "Не вдалося перейменувати {oldName} на {name}.",
    "Rename person" : "Перейменувати особу",
    "Name" : "Назва",
    "Update" : "Оновлювати",
    "Failed to load faces" : "Не вдалося навантажити вибої",
    "Create a new face with this name?" : "Створити нове обличчя з таким ім'ям?",
    "Create new face" : "Створіть нове обличчя",
    ...
    "Merge {name} with person" : "Об'єднати {name} з людиною",
    ...
    "Move selected photos to person" : "Перемістити вибрані фотографії до особи",
    "Choose a folder" : "Виберіть каталог",
    "_{n} item copied to folder_::_{n} items copied to folder_" : ["{n} елемент скопійовано до папки","{n} елементи, скопійовані до папки","{n} елементи, скопійовані до папки","{n} елементи, скопійовані до папки"],
    ...
    "Failed to copy link to clipboard" : "Не вдалося скопіювати посилання до буфера обміну",
    ...
    "Click a link to copy to clipboard." : "Клацніть на посилання, щоб скопіювати до буфера обміну.",
    ...
    "Failed to download file {href}" : "Не вдалося звантажити файл {href}",
    "Cannot share this type of data" : "Неможливо надати доступ до цього типу даних",
    "Reduced Size" : "Зменшений розмір",
    "Share in lower quality (small file size)" : "Поділітися у нижчій якості (малий розмір файлу)",
    "High Resolution" : "Висока роздільна здатність",
    "Share in high quality (large file size)" : "Поділітися у високій якості (великий розмір файлу)",
    "Original File" : "Оригінальний файл",
    "Public Link" : "Публічне посилання",
    "Share an external Nextcloud link" : "Поділітися зовнішнім посиланням у Nextcloud",
    ...
    "No albums selected" : "Не вибрано жодного альбому",
    "Choose the destination folder for the upload" : "Виберіть папку призначення для завантаження",
    "Creating tags" : "Створення міток",
    "Uploading {file}" : "Завантаження {file}",
    "Failed to upload {file}" : "Не вдалося завантажити {file}",
    "Adding files to album {album}" : "Додавання файлів до альбому {album}",
    "Attaching tags to {file}" : "Призначення міток до {file}",
    "Failed to attach tags to {file}" : "Не вдалося призначити мітки до {file}",
    "Some files have not been uploaded." : "Деякі файли не були завантажені.",
    "Destination path" : "Шлях до місця призначення",
    "Add to albums" : "Додати в альбоми",
    "Add tags" : "Додати мітки",
    "Attach collaborative tags to all uploads" : "Додайте мітки для спільної роботи до всіх завантажених файлів",
    "_Upload {n} file_::_Upload {n} files_" : ["Завантажити файл {n} ","Завантажте файли {n} ","Завантажте файли {n} ","Завантажте файли {n} "],
    ...
    "Share album" : "Поділитися альбомом",
    "Download album" : "Звантажити альбом",
    "Remove album" : "Вилучити альбом",
    ...
    "Folder view" : "Перегляд папок",
    "Timeline view" : "Перегляд часової шкали",
    "Move left" : "Перемістити ліворуч",
    "Move right" : "Перемістити праворуч",
    "Unidentified location" : "Невстановлене місцезнаходження",
    "Files without location" : "Файли без місцезнаходження",
    "Upload failed" : "Помилка завантаження",
    "Image saved successfully" : "Зображення успішно збережено",
    "Error saving image: {error}" : "Помилка збереження зображення: {error}",
    ...
    "Access to media has been granted." : "Надано доступ до засобів масової інформації.",
    ...
    "{name} failed test: {info}." : "{name} не пройшов тест: {info}.",
    ...
    "Save as" : "Зберегти як",
    "Are you sure you want to discard the changes?" : "Ви впевнені, що хочете відмовитися від змін?",
    "Undo" : "Скасувати",
    "Redo" : "Повторити",
    ...
    "Setup" : "Налаштування",
    "Failed to add {filename} to album." : "Не вдалося додати {filename} до альбому.",
    "Failed to remove {filename}." : "Не вдалося вилучити {filename}.",
    "Failed to create {albumName}." : "Не вдалося створити {albumName}.",
    "Failed to update properties of {albumName} with {properties}." : "Не вдалося оновити властивості {albumName} на {properties}.",
    ...
    "Failed to copy files." : "Не вдалося скопіювати файли.",
    "Could not copy {fileName}, target exists." : "Не вдалося скопіювати {fileName}, ціль існує.",
    "Failed to copy {fileName}." : "Не вдалося скопіювати {fileName}.",
    ...
    "Failed to download files" : "Не вдалося звантажити файли",
    "Failed to remove {filename} from face." : "Не вдалося видалити {filename} з обличчя.",
    "Failed to move {filename} from face." : "Не вдалося перенести {filename} з обличчя.",
    ...
    "Cover image set successfully" : "Зображення обкладинки успішно встановлено",
    "Failed to set cover image" : "Не вдалося встановити зображення обкладинки",
    "No content-location header found" : "Не знайдено заголовка розташування контенту",
    "Failed to create tag {name}: {error}" : "Не вдалося створити мітку {name}: {error}",
