OC.L10N.register(
    ...
    "Show photo owner name on timeline" : "Show photo owner name on timeline",
    "Autoplay Live Photos" : "Autoplay Live Photos",
    "Loop Live Photos" : "Loop Live Photos",
    "Loop Videos" : "Loop Videos",
    "Show full file path in sidebar" : "Show full file path in sidebar",
    "Show metadata in slideshow" : "Show metadata in slideshow",
    "Slideshow Duration (1-60 seconds)" : "Slideshow Duration (1-60 seconds)",
    ...
    "Number of days before and after each anniversary" : "Number of days before and after each anniversary",
    "Photos per year (1-50)" : "Photos per year (1-50)",
    "Maximum number of photos to include per year" : "Maximum number of photos to include per year",
    "Info" : "Info",
    "Close" : "Close",
    ...
    "You can optionally exclude specific folder names from being indexed." : "You can optionally exclude specific folder names from being indexed.",
    "Excluded folder names (comma-separated)" : "Excluded folder names (comma-separated)",
    ...
    "You are using SQLite, which is not recommended for performance." : "You are using SQLite, which is not recommended for performance.",
    "innodb_buffer_pool_size is set to {size} GiB (minimum recommended: {minimum} GiB)." : "innodb_buffer_pool_size is set to {size} GiB (minimum recommended: {minimum} GiB).",
    ...
    "Memories supports offline reverse geocoding using OpenStreetMap data on MySQL and Postgres." : "Memories supports offline reverse geocoding using OpenStreetMap data on MySQL and Postgres.",
    ...
    "Location search endpoint for metadata editor" : "Location search endpoint for metadata editor",
    ...
    "VA-API device path" : "VA-API device path",
    ...
    "Connection addresses (comma separated)" : "Connection addresses (comma separated)",
    ...
    "Template" : "Template",
    "Shared" : "Shared",
    "Find photos matching “{query}”" : "Find photos matching “{query}”",
    ...
    "Empty" : "Empty",
    "Unchanged" : "Unchanged",
    "Failed to search for location." : "Failed to search for location.",
    "Reset" : "Reset",
    ...
    "Failed to download file for sharing" : "Failed to download file for sharing",
    ...
    "Upload not permitted" : "Upload not permitted",
    "_Skipped {n} file that already exists_::_Skipped {n} files that already exist_" : ["Skipped {n} file that already exists","Skipped {n} files that already exist"],
    "Uploading {file} ({current}/{total})" : "Uploading {file} ({current}/{total})",
    "Upload failed" : "Upload failed",
    "_Successfully uploaded {n} file_::_Successfully uploaded {n} files_" : ["Successfully uploaded {n} file","Successfully uploaded {n} files"],
    "Uploaded {success} files, {failed} failed" : "Uploaded {success} files, {failed} failed",
    "_Failed to upload {n} file_::_Failed to upload {n} files_" : ["Failed to upload {n} file","Failed to upload {n} files"],
    ...
    "{srv} - Healthy ({version})." : "{srv} - Healthy ({version}).",
    "{srv} - Unhealthy ({info})." : "{srv} - Unhealthy ({info}).",
    "Save as" : "Save as",
