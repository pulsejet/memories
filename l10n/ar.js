OC.L10N.register(
    ...
    "You are about to move a large number of files. Are you sure?" : "أنت على وشك أن تقوم بنقل عدد كبير من الملفات. هل أنت متأكد؟",
    ...
    "Recognize is installed and enabled." : "تطبيق \"التعرُّف على الصور\" Recognize مُثبّت و مُمَكّن.",
    "Recognize is not installed. Some features like face recognition and object tagging may be unavailable." : "تطبيق \"التعرُّف على الصور\" Recognize غير مُثبّت. بعض الخصائص مثل التعرُّف على الوجوه و توسيم الأجسام object tagging يمكن ألاّ تكون متاحةً.",
