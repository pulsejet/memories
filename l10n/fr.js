OC.L10N.register(
    ...
    "Day range (1-7)" : "Intervalle de jours (1-7)",
    ...
    "You can optionally use a regular expression to exclude matching paths from being indexed." : "Vous pouvez éventuellement utiliser une expression régulière pour exclure les chemins correspondants de l'indexation.",
    "For example, to exclude special QNAP folders:" : "Par exemple, pour exclure les dossiers QNAP spéciaux :",
    "Or, exclude all files starting with \"private-\" or \"backup-\":" : "Ou, pour exclure tous les fichiers commençant par « private- » ou « backup- ».",
    "You can use the regex101 website to validate and test the pattern:" : "Vous pouvez utiliser le site regex101 pour valider et tester le motif :",
    "Exclude paths matching regular expression" : "Exclure les chemins correspondant à une expression régulière",
