OC.L10N.register(
    ...
    "Photos" : "Fotoğraflar",
    "Upload Local" : "Yerel dosyayı yükle",
    "Delete" : "Sil",
    ...
    "Show past photos on top of timeline" : "Geçmiş fotoğraflar zaman tünelinin üzerinde görüntülensin",
    "Stack RAW files with same name" : "RAW dosyalarını aynı adla derle",
    "De-duplicate identical files" : "Eş dosyaları birleştir",
    "Show photo owner name on timeline" : "Zaman tünelinde fotoğraf sahibinin adı görüntülensin",
    ...
    "Slideshow Duration (1-60 seconds)" : "Slayt sunumu süresi (1-60 saniye)",
    ...
    "Day range (0-7)" : "Gün aralığı (0-7)",
    "Number of days before and after each anniversary" : "Her yıl dönümünden önceki ve sonraki gün sayısı",
    "Photos per year (1-50)" : "Bir yıldaki fotoğraf (1-50)",
    "Maximum number of photos to include per year" : "Bir yıl için katılacak en fazla fotoğraf sayısı",
    "Info" : "Bilgiler",
    "Close" : "Kapat",
    ...
    "You can optionally exclude specific folder names from being indexed." : "İsteğe bağlı olarak belirli klasör adlarını dizine katmayabilirsiniz.",
    "Excluded folder names (comma-separated)" : "Katılmayacak klasör adları (virgül ile ayrılmış)",
    ...
    "You are using SQLite, which is not recommended for performance." : "Başarım açısından önerilmeyen SQLite kullanıyorsunuz.",
    "innodb_buffer_pool_size is set to {size} GiB (minimum recommended: {minimum} GiB)." : "innodb_buffer_pool_size değeri {size} GiB olarak ayarlanmış (önerilen en az değer: {minimum} GiB).",
    ...
    "Memories supports offline reverse geocoding using OpenStreetMap data on MySQL and Postgres." : "Anılar, MySQL ya da Postgres üzerinde OpenStreetMap verilerini kullanarak çevrim dışı ters coğrafi kodlamayı destekler.",
    ...
    "Location search endpoint for metadata editor" : "Üst veri düzenleyici için konum arama uç noktası",
    ...
    "Connection addresses (comma separated)" : "Bağlantı adresleri (virgül ile ayrılmış)",
    ...
    "Template" : "Kalıp",
    "Shared" : "Paylaşılan",
    "Find photos matching “{query}”" : "“{query}” ile eşleşen fotoğrafları bul",
    ...
    "Failed to search for location." : "Konum aranamadı.",
    "Reset" : "Sıfırla",
    ...
    "_Failed to load metadata for {n} photo._::_Failed to load metadata for {n} photos._" : ["{n} fotoğrafın üst verileri yüklenemedi.","{n} fotoğrafın üst verileri yüklenemedi."],
    "_{n} photo cannot be edited (permissions error)._::_{n} photos cannot be edited (permissions error)._" : ["{n} fotoğraf düzenlenemedi (izin sorunu).","{n} fotoğraf düzenlenemedi (izin sorunu)."],
    ...
    "You can only merge with a named person" : "Yalnızca adlandırılmış bir kişiyi birleştirebilirsiniz",
    ...
    "Failed to download file for sharing" : "Dosya paylaşım için indirilemedi",
    ...
    "Expand details" : "Ayrıntıları görüntüle",
    ...
    "Choose the folders on this device to show on your timeline." : "Bu aygıttaki zaman tünelinde görüntülenecek klasörleri seçin.",
    ...
    "{srv} - Healthy ({version})." : "{srv} - Sağlıklı ({version}).",
    "{srv} - Unhealthy ({info})." : "{srv} - Sağlıksız ({info}).",
    ...
    "Height in pixels" : "Piksel olarak yüksekilk",
    ...
    "Add photos to albums by selecting them on your timeline." : "Fotoğrafları zaman tünelinizden seçerek albümlere ekleyin.",
    ...
    "_You are about to download {count} item._::_You are about to download {count} items._" : ["{count} ögeyi indirmek üzeresiniz.","{count} ögeyi indirmek üzeresiniz."],
    "_You are about to move {count} item._::_You are about to move {count} items._" : ["{count} ögeyi taşımak üzeresiniz.","{count} ögeyi taşımak üzeresiniz."]
},
