OC.L10N.register(
    ...
    "You must enable \"Mark person in preview\" to use this feature" : "Bu özelliği kullanabilmek için \"Kişiyi ön izlemede işaretle\" seçeneğini kullanıma almalısınız",
    ...
    "Recognize is installed and enabled for face recognition." : "Yüz tanıma için Tanıma uygulaması kurulmuş ve kullanıma alınmış.",
    "Recognize is installed but not enabled for face recognition." : "Yüz tanıma için Tanıma uygulaması kurulmuş ve ancak kullanıma alınmamış.",
    ...
    "Face Recognition is installed and enabled" : "Yüz tanıma kurulmuş ve kullanıma alınmış",
    "Preview generator is installed and enabled. Additional configuration may still be required." : "Ön izleme oluşturucu kurulmuş ve kullanıma alınmış. Ek yapılandırma işlemleri gerekli olabilir.",
    ...
    "You can configure the enabled Nextcloud preview providers below." : "Kullanıma alınmış Nextcloud ön izleme hizmetlerini aşağıdan yapılandırabilirsiniz.",
    ...
    "To enable RAW support, install the Camera RAW Previews app." : "RAW desteğini kullanıma almak için Camera RAW Previews uygulamasını kurun.",
    ...
    "Only server-side encryption (OC_DEFAULT_MODULE) is supported, but another encryption module is enabled." : "Yalnızca sunucu tarafında şifreleme (OC_DEFAULT_MODULE) desteklenir. Ancak başka bir şifreleme modülü kullanıma alınmış.",
    ...
    "Make sure you test hardware acceleration with various options after enabling." : "Donanım hızlandırmayı kullanıma aldıktan  sonra çeşitli seçenekleri sınadığınızdan emin olun.",
    "Do not enable multiple types of hardware acceleration simultaneously." : "Aynı anda birden fazla donanım hızlandırmasını kullanıma almayın.",
    ...
    "Some drivers (e.g. AMD and older Intel) do not support hardware accelerated rotation. You can attempt to force software-based transpose in this case." : "Bazı sürücüler (örneğin AMD ve daha eski Intel) donanım hızlandırmalı rotasyonu desteklemez. Bu durumda yazılımsal dönüştürmeyi dayatmayı deneyebilirsiniz.",
    ...
    "Memories uses the go-vod transcoder. You can run go-vod exernally (e.g. in a separate Docker container for hardware acceleration) or use the built-in transcoder. To use an external transcoder, enable the following option and follow the instructions in the documentation:" : "Anılar, go-vod kod çözücüsünü kullanır. Go-vod dışarıdan çalıştırılabilir (örneğin, donanım hızlandırması için ayrı bir Docker kapsayıcısında) ya da yerleşik kod çözücü kullanılabilir. Bir dış kod çözücü kullanmak için aşağıdaki seçeneği kullanıma alın ve belgelerdeki yönergeyi izleyin:",
    ...
    "You can only merge with a person with name" : "Yalnızca adı olan bir kişiyi aktarabilirsiniz",
    ...
    "Previous" : "Önceki",
    "Next" : "Sonraki",
    "Editing is currently disabled for Live Photos" : "Live Photos üzerinde düzenleme şu anda kullanımdan kaldırılmış",
    ...
    "Face Recognition is disabled. Enable in settings to find your friends" : "Yüz tanıma özelliği kullanımdan kaldırılmış. Arkadaşlarınızı bulmak için ayarlar bölümünden kullanıma alın",
