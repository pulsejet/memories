OC.L10N.register(
    ...
    "Failed to load some photos" : "Einige Fotos konnten nicht geladen werden",
    ...
    "You can manually retry files that failed indexing." : "Sie können Dateien, deren Indizierung fehlgeschlagen ist, manuell erneut indizieren.",
    ...
    "You can optionally exclude specific folder names from being indexed." : "Optional können bestimmte Ordnernamen von der Indizierung ausgeschlossen werden.",
    "Excluded folder names (comma-separated)" : "Ausgeschlossene Ordnernamen (durch Kommas getrennt)",
    ...
    "See the documentation for information on how to resolve this." : "Informationen zur Behebung dieses Problems finden Sie in der Dokumentation.",
    "You are using SQLite, which is not recommended for performance." : "SQLite wird verwendet, was aus Leistungsgründen nicht zu empfehlen ist.",
    "innodb_buffer_pool_size is set to {size} GiB (minimum recommended: {minimum} GiB)." : "innodb_buffer_pool_size ist auf {size} GiB eingestellt (empfohlenes Minimum: {minimum} GiB).",
    ...
    "Connection addresses (comma separated)" : "Verbindungsadressen (kommagetrennt)",
    ...
    "Template" : "Vorlage",
    "Shared" : "Geteilt",
    "Find photos matching “{query}”" : "Suche Fotos, die mit  \"{query}\" übereinstimmen",
    "Search your photos …" : "Ihre Fotos durchsuchen …",
    "Start typing to find photos and albums" : "Mit der Eingabe beginnen, um Fotos und Alben zu finden",
    ...
    "Newest date is older than oldest date" : "Jüngstes Datum ist älter als das älteste Datum",
    "Newest" : "Neueste",
    "Year" : "Jahr",
    "Month" : "Monat",
    "Day" : "Tag",
    ...
    "This feature rotates images losslessly by updating the EXIF metadata. This approach is known to sometimes not work correctly on certain image types such as HEIC. Make sure you do a test run before using it on multiple images." : "Diese Funktion dreht Bilder verlustfrei, indem die EXIF-Metadaten aktualisiert werden. Dies funktioniert bei bestimmten Bildtypen wie HEIC manchmal nicht richtig. Führen Sie zunächst einen Testlauf durch, bevor Sie diese Funktion für mehrere Bilder verwenden.",
    ...
    "You can only merge with a named person" : "Sie können nur mit einer Person mit Namen zusammenführen",
    ...
    "You cannot share the root folder" : "Das Wurzelverzeichnis kann nicht geteilt werden",
    ...
    "Click a link to copy to clipboard." : "Auf einen Link klicken, um ihn in die Zwischenablage zu kopieren.",
    ...
    "You are now logged in to the server!" : "Sie sind jetzt am Server angemeldet!",
    "You can set up automatic uploads from this device using the Nextcloud mobile app. Click the button below to download the app, or skip this step and continue." : "Mit der mobilen Nextcloud-App können Sie automatische Uploads von diesem Gerät einrichten. Klicken Sie auf die Schaltfläche unten, um die App herunterzuladen, oder überspringen Sie diesen Schritt und fahren Sie fort.",
    ...
    "This may take a while. Do not close this window." : "Das kann eine Weile dauern. Schließen Sie dieses Fenster nicht.",
    "Finish" : "Beenden",
    ...
    "{srv} - Healthy ({version})." : "{srv} - Gesund ({version}).",
    "{srv} - Unhealthy ({info})." : "{srv} - Ungesund ({info}).",
    ...
    "Failed to move {filename} from face." : "{filename} konnte nicht vom Gesicht verschoben werden.",
    ...
    "_You are about to download {count} item._::_You are about to download {count} items._" : ["Sie sind dabei, {count} Element herunterzuladen.","Sie sind dabei, {count} Elemente herunterzuladen."],
    "_You are about to move {count} item._::_You are about to move {count} items._" : ["Sie sind dabei, {count} Element zu verschieben.","Sie sind dabei, {count} Elemente zu verschieben."]
},
