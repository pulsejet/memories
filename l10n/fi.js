OC.L10N.register(
    ...
    "Rotate / Flip" : "Käännä / peilaa",
    "View in folder" : "Näe kansiossa",
    "Set as cover image" : "Aseta kansikuvaksi",
    ...
    "Show hidden albums" : "Näytä piilotetut albumit",
    "Info" : "Tietoa",
    "Close" : "Sulje",
    ...
    "Thumbnail generation may not work for videos." : "Pienoiskuvien luonti ei välttämättä toimi videoille.",
    ...
    "Thank you for choosing Nextcloud and Memories to store your precious data!" : "Kiitos kun valitsit Nextcloudin ja Muistot arvokkaan datasi säilömiseen!",
    "Memories is very feature rich and setting it up properly can take some time." : "Muistot on runsas toiminnoiltaan ja sen käyttökuntoon asettaminen voi viedä hetken aikaa.",
    "If you just installed Memories, make sure you read the getting started guide:" : "Jos olet juuri asentanut Muistot, luethan aloitusoppaan:",
    "External Link" : "Ulkoinen linkki",
    "In case you run into any issues or bugs, you can get help through several channels." : "Jos vastaasi tulee ongelmia tai bugeja, saat apua muutamien kanavien kautta.",
    "Memories is a completely free and open source app under active development." : "Muistot on aktiivisesti kehityksessä oleva täysin ilmainen, avoimen lähdekoodin sovellus.",
    "You can contribute in several ways. See the project page for more details:" : "Voit osallistua eri tavoin. Katso lisätietoja projektisivulta:",
    "Media Indexing" : "Median indeksointi",
    "{n} media files have been indexed" : "{n} mediatiedostoa on indeksoitu",
    "{n} media files failed indexing and were skipped." : "{n} mediatiedoston indeksointi epäonnistui ja ne ohitettiin.",
    "View failure logs." : "Katso virhelokit.",
    "Files that failed indexing will not be indexed again unless they change." : "Tiedostoja, joiden indeksointi epäonnistui, ei indeksoida uudelleen elleivät ne muutu.",
    ...
    "Looks like it has been more than an hour since the last index job was run. Make sure Nextcloud cron is configured correctly." : "Näyttää siltä, että edellisestä indeksoinnista on kulunut yli tunti. Varmista, että Nextcloudin cron on määritelty oikein.",
    ...
    "Index a fixed relative path" : "Indeksoi erikseen määritelty suhteellinen polku",
    "Disable background indexing" : "Poista käytöstä indeksointi taustalla",
    "Indexing path (relative, all users)" : "Indeksoitava polku (suhteellinen, kaikille käyttäjille)",
    "Folders with a \".nomedia\" or a \".nomemories\" file are always excluded from indexing." : "Kansiot, jotka sisältävät tiedoston \".nomedia\" tai \".nomemories\", ohitetaan aina indeksoinnissa.",
    "You can optionally use a regular expression to exclude matching paths from being indexed." : "Voit vaihtoehtoisesti käyttää säännöllisiä lausekkeita (RegEx) ohittaaksesi polkuja indeksoinnissa.",
    "For example, to exclude special QNAP folders:" : "Esimerkiksi ohittaaksesi erityisiä QNAP-kansioita:",
    "Or, exclude all files starting with \"private-\" or \"backup-\":" : "Tai ohittaaksesi kaikki tiedostot, joiden nimi alkaa \"private-\" tai \"varmuuskopio-\":",
    "You can use the regex101 website to validate and test the pattern:" : "Voit käyttää regex101-verkkosivua validoidaksesi ja testaaksesi kuviota:",
    "Exclude paths matching regular expression" : "Ohita polut, jotka täsmäävät säännölliseen lausekkeeseen (RegEx)",
    "For advanced usage, perform a run of indexing by running:" : "Edistyneeseen käyttöön käynnistä indeksointi komentoriviltä suorittamalla:",
    "Run index in parallel with 4 threads:" : "Suorita ineksointi neljällä rinnakkaisella säikeellä:",
    "Force re-indexing of all files:" : "Pakota kaikkien tiedostojen uudelleenindeksointi:",
    "You can limit indexing by user and/or folder:" : "Voit rajoittaa indeksointia käyttäjän ja/tai polun perusteella:",
    "Clear all existing index tables:" : "Poista kaikki olemassaolevat indeksointitaulukot:",
    "Performance" : "Suorituskyky",
    "Unknown" : "Tuntematon",
    "HTTPS is enabled" : "HTTPS on käytössä",
    "HTTP/2 or HTTP/3 is enabled" : "HTTP/2 tai HTTP/3 on käytössä",
    "HTTP/2 or HTTP/3 is strongly recommended ({httpVer} detected)" : "Suositellaan vahvasti HTTP/2:n tai HTTP/3:n käyttöä ({httpVer} tunnistettu)",
    "See the documentation for information on how to resolve this." : "Lue dokumentaatiosta tietoa tämän ratkaisemiseksi.",
    "This may also cause all photos to be re-indexed!" : "Tämä voi aiheuttaa kaikkien kuvien uudelleenideksoinnin!",
    "Continue" : "Jatka",
    "Video Streaming" : "Videon striimaus",
    ...
    "Quality Factor (15 - 45) (default 25)" : "Laadun kerroin (15 - 45) (oletus 25)",
    "Template" : "Malli",
    "Shared" : "Jaettu",
    "Search your photos …" : "Etsi kuvia...",
    "Start typing to find photos and albums" : "Aloita kirjoittaminen löytääksesi valokuvia ja albumeita",
    ...
    "Leave Album" : "Poistu albumista",
    "Are you sure you want to permanently remove album \"{name}\"?" : "Haluatko varmasti poistaa albumin \"{name}\"?",
    "Are you sure you want to leave the shared album \"{name}\"?" : "Haluatko varmasti poistua jaetusta albumista \"{name}\"?",
    "Save" : "Tallenna",
    ...
    "_Removed from {n} album_::_Removed from {n} albums_" : ["Poistettu {n} albumista","Poistettu {n} albumista"],
    "Failed to load album info: {name}" : "Albumin tietojen haku epäonnistui: {name}",
    ...
    "Name" : "Nimi",
    "Update" : "Päivitä",
    "Failed to load faces" : "Kasvojen lataus epäonnistui",
    "Create a new face with this name?" : "Luodaanko uusi kasvo tällä nimellä?",
    "Create new face" : "Luo uusi kasvo",
    ...
    "Move the selected photos to {target}?" : "Siirretäänkö valitut kuvat kohteeseen {target}?",
    "Move" : "Siirrä",
    "An error occurred while moving photos from {name}." : "Virhe kuvien siirrossa kohteesta {name}.",
    ...
    "Refresh" : "Päivitä",
    "Failed to create album for public link" : "Albumin luonti julkiselle linkille epäonnistui",
    "Failed to download file {href}" : "Tiedoston {href} lataus epäonnistui",
    "Cannot share this type of data" : "Tämän tyyppistä dataa ei voida jakaa",
    "Reduced Size" : "Pienennetty koko",
    "Share in lower quality (small file size)" : "Jaa matalammalla laadulla (pienempi tiedoston koko)",
    "High Resolution" : "Korkea resoluutio",
    "Share in high quality (large file size)" : "Jaa korkealla laadulla (suuri tiedoston koko)",
    "Original File" : "Alkuperäinen tiedosto",
    "Public Link" : "Julkinen linkki",
    "Share an external Nextcloud link" : "Jaa ulkoinen Nextcloud-linkki",
    "_Share File_::_Share Files_" : ["Jaa tiedosto","Jaa tiedostoja"],
    "_Share the original file_::_Share the original files_" : ["Jaa alkuperäinen tiedosto","Jaa alkuperäiset tiedostot"],
    "No albums selected" : "Ei albumeita valittuna",
    "Choose the destination folder for the upload" : "Valitse latauksen kohdekansio",
    "Creating tags" : "Luodaan tunnisteita",
    "Uploading {file}" : "Ladataan {file}",
    "Failed to upload {file}" : "Tiedoston {file} lataus epäonnistui",
    "Adding files to album {album}" : "Lisätään tiedostoja albumiin {album}",
    "Attaching tags to {file}" : "Lisätään tunnisteita tiedostoon {file}",
    "Failed to attach tags to {file}" : "Tunnisteiden lisääminen tiedostoon {file} epäonnistui",
    "Some files have not been uploaded." : "Joitain tiedostoja ei ladattu.",
    "Destination path" : "Kohdekansio",
    "Add to albums" : "Lisää albumeihin",
    "Add tags" : "Lisää tunnisteita",
    "_Upload {n} file_::_Upload {n} files_" : ["Lataa {n} tiedosto","Lataa {n} tiedostoa"],
    ...
    "Download {ext}" : "Lataa {ext}",
    "Slideshow" : "Diaesitys",
    "Previous" : "Edellinen",
    "Next" : "Seuraava",
    "Editing is currently disabled for Live Photos" : "Muokkaus ei ole tällä hetkellä käytössä Livekuville",
    "You are now logged in to the server!" : "Olet nyt kirjautuneena palvelimelle!",
    "You can set up automatic uploads from this device using the Nextcloud mobile app. Click the button below to download the app, or skip this step and continue." : "Voit asettaa automaattisen latauksen tältä laitteelta käyttäen Nextcloud-sovellusta. Klikkaa allaolevaa painiketta lataaksesi sovelluksen tai ohita tämä vaihe jatkaaksesi.",
    "Set up automatic upload" : "Aseta automaattinen lataus",
    "Memories can show local media on your device alongside the media on your server. This requires access to the media on this device." : "Muistot voi näyttää laitteesi paikallisen median palvelimella olevan median lisäksi. Tämä vaatii median käyttöoikeuden tällä laitteella.",
    "Access to media has been granted." : "Median käyttöoikeus on myönnetty.",
    "Access to media is not available yet. If the button below does not work, grant the permission through settings." : "Median käyttöoikeutta ei ole vielä myönnetty. Jos painike alla ei toimi, myönnä käyttöoikeus asetuksissa.",
    "Grant permissions" : "Myönnä käyttöoikeuksia",
    "Skip this step" : "Ohita",
    "Choose the folders on this device to show on your timeline." : "Näytä tämän laitteen kansiot, jotka näytetään aikajanallasi.",
    "If no folders are visible here, you may need to grant the app storage permissions, or wait for the app to index your files." : "Jos kansioita ei näy, saatat joutua myöntämään sovellukselle tallennustilan käyttöoikeuden tai odottaa, että sovellus on indeksoinut tiedostosi.",
    "You can always change this in settings. Note that this does not affect automatic uploading." : "Voit aina muuttaa tätä asetusta. Huomioi, että tämä ei vaikuta automaattiseen lataukseen.",
    "Synchronizing local files ({n} done)." : "Synkronoidaan paikallisia tiedostoja ({n} valmiina).",
    "This may take a while. Do not close this window." : "Tämä saattaa viedä hetken. Älä sulje tätä ikkunaa.",
    "Finish" : "Valmis",
    ...
    "Are you sure you want to discard the changes?" : "Haluatko varmasti hylätä muutokset?",
    "Undo" : "Kumoa",
    "Redo" : "Tee uudelleen",
    ...
    "Failed to load image info: {name}" : "Kuvan tietojen haku epäonnistui: {name}",
    ...
    "Failed to create tag {name}: {error}" : "Tunnisteen {name} luonti epäonnistui: {error}",
    ...
    "Add photos to albums by selecting them on your timeline." : "Lisää valokuvia albumeihin valitsemalla niitä aikajanallasi.",
    ...
    "Choose" : "Valitse",
    "The folder name \"{folder}\" has a leading or trailing whitespace. This may lead to errors and should be corrected." : "Kansion nimessä \"{folder}\" on alussa tai lopussa tyhjä merkki. Tämä saattaa johtaa virheisiin ja tulee muuttaa.",
