OC.L10N.register(
    ...
    "De-duplicate identical files" : "Usuń duplikaty identycznych plików",
    ...
    "Folders with a \".nomedia\" or a \".nomemories\" file are always excluded from indexing." : "Katalogi z plikiem \".nomedia\" lub \".nomemories\" są zawsze wykluczone z indeksowania.",
    ...
    "You can limit indexing by user and/or folder:" : "Można ograniczyć indeksowanie według użytkownika i/lub katalogu:",
    ...
    "See the documentation for information on how to resolve this." : "Informacje o tym, jak rozwiązać ten problem, można znaleźć w dokumentacji.",
    ...
    "Choose the destination folder for the upload" : "Wybierz katalog docelowy dla przesłania",
    "Failed to upload {file}" : "Nie udało się wysłać {file}",
    "Some files have not been uploaded." : "Niektóre pliki nie zostały przesłane.",
