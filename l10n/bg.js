OC.L10N.register(
    ...
    "No photos were found in the selected folder." : "Не бяха намерени снимки в избраните папка.",
    "This can happen because your media is still indexing." : "Това може да се случва, защото медийните файлове все още се индексират.",
    "Visit the admin panel to make sure Memories is configured correctly." : "Посетете администраторския панел, за да се уверите, че Memories е конфигуриран правилно.",
    ...
    "If you just installed Memories, visit the admin panel first." : "Ако току-що сте инсталирали Memories, първо посетете администраторския панел.",
    ...
    "Metadata" : "Метаданни",
    "Edit" : "Редактиране",
    "Failed to load metadata" : "Неуспешно зареждане на метаданните.",
    "Photos" : "Снимки",
    "Delete" : "Изтриване",
    ...
    "Rotate / Flip" : "Завъртане / Обръщане",
    "View in folder" : "Преглед в папка",
    "Set as cover image" : "Направи за изображение на корицата",
    ...
    "Sign out" : "Изход",
    "Are you sure you want to log out {user}?" : "Сигурни ли сте, че искате да излезете {user}?",
    ...
    "Stack RAW files with same name" : "Събери RAW файлове с едно и също име",
    "De-duplicate identical files" : "Премахни дублиращите се файлове",
    "Show photo owner name on timeline" : "Покажи името на собственика на снимката в хронологията",
    "Autoplay Live Photos" : "Автоматично пускане на Live Photos",
    "Loop Live Photos" : "Повтаряне на Live Photos",
    "Loop Videos" : "Повтаряне на видеа",
    "Show full file path in sidebar" : "Покажи пълния път на файла в страничната лента",
    "Show metadata in slideshow" : "Покажи метаданните в слайдшоуто",
    "High resolution image loading behavior" : "Поведение при зареждане на изображение с висока резолюция",
    "Load high resolution image on zoom" : "Зареждане на изображение с висока резолюция при увеличение",
    "Always load high resolution image (not recommended)" : "Винаги зареждай изображение с висока резолюция (не се препоръчва)",
    "Never load high resolution image" : "Никога не зареждай изображение с висока резолюция",
    "Logged in as {user}" : "Влезли сте като {user}",
    "Local folders to include in the timeline view" : "Локални папки за включване в изгледа на хронологията",
    ...
    "If you are using Imaginary for preview generation, you can ignore this section." : "Ако използвате \"Imaginary\" за генериране на иконки, може да игнорирате този раздел.",
    ...
    "Choose" : "Изберете",
    "The folder name \"{folder}\" has a leading or trailing whitespace. This may lead to errors and should be corrected." : "Името на папка \"{folder}\" съдържа водещ или завършващ интервал. Това може да доведе до грешки и трябва да се коригира.",
    "Files in trash may be automatically deleted after a fixed period of time." : "Файловете в кошчето могат да бъдат автоматично изтрити след определен период от време."
},
