OC.L10N.register(
    ...
    "Slideshow Duration (1-60 seconds)" : "投影片播放時間（1-60 秒）",
    ...
    "Day range (1-7)" : "日範圍 (1-7)",
    "Number of days before and after each anniversary" : "每個紀念日前後的天數",
    "Photos per year (1-50)" : "每年的照片數 (1-50)",
    "Maximum number of photos to include per year" : "每年最多可包含的照片數量",
    "Info" : "資訊",
    "Close" : "關閉",
    ...
    "Memories supports offline reverse geocoding using OpenStreetMap data on MySQL and Postgres." : "Memories 支援透過 MySQL 與 Postgres 上的開放街圖資料進行離線反向地理編碼。",
    ...
    "Location search endpoint for metadata editor" : "中介資料編輯器的位置搜尋端點",
    ...
    "VA-API device path" : "VA-API 裝置路徑",
    ...
    "Connection addresses (comma separated)" : "連線地址（以英式逗號分隔）",
    ...
    "Empty" : "空的",
    "Unchanged" : "未變更",
    "Failed to search for location." : "搜尋位置失敗。",
    "Reset" : "重設",
    ...
    "Failed to download file for sharing" : "無法下載待分享的檔案",
    ...
    "{srv} - Healthy ({version})." : "{srv} - 健康 ({version}).",
    "{srv} - Unhealthy ({info})." : "{srv} - 不健康 ({info}).",
    "Save as" : "另存新檔",
