OC.L10N.register(
    ...
    "Set as cover image" : "Nastavit jako obrázek přebalu",
    ...
    "Show photo owner name on timeline" : "Zobrazovat v časové ose jméno vlastníka fotky",
    "Autoplay Live Photos" : "Automaticky přehrávat živé fotky",
    "Loop Live Photos" : "Přehrávat živé fotky ve smyčce",
    "Loop Videos" : "Přehrávat videa ve smyčkách",
    ...
    "Number of days before and after each anniversary to include" : "Počet zahrnutých dní před a po každém výročí",
    "Photos per year (1-50)" : "Fotky na rok (1-50)",
    "Maximum number of photos to include per year" : "Maximální počet zarhnutých fotek na rok",
    "Info" : "Informace",
    "Close" : "Zavřít",
    ...
    "Imaginary (not recommended)" : "Imaginary (nedoporučováno)",
    ...
    "{n} media files failed indexing and were skipped." : "U {n} souborů médií se nepodařilo vytvořit rejstřík a byly přeskočeny.",
    "View failure logs." : "Zobrazit záznamy událostí při nezdaru.",
    "Files that failed indexing will not be indexed again unless they change." : "Soubory u kterých se nezdařilo vytvoření rejstříku už nebudou takto zpracovány dokud nebudou změněny.",
    "You can manually retry files that failed indexing." : "U souborů, pro které se nezdařilo vytvoření rejstříku, je možné ručně zkusit znovu.",
    ...
    "You can optionally use a regular expression to exclude matching paths from being indexed." : "Je možné volitelně použít regulární výraz a vynechat tak jemu odpovídající popisy umístění z vytváření rejstříku.",
    "For example, to exclude special QNAP folders:" : "Například, pro vynechání speciálních složek na QNAP:",
    "Or, exclude all files starting with \"private-\" or \"backup-\":" : "Nebo vynechat veškeré soubory začínající na „private-“ nebo „backup-“:",
    "You can use the regex101 website to validate and test the pattern:" : "Pro ověření a vyzkoušení vzoru je možné použít web regex101:",
    "Exclude paths matching regular expression" : "Vynechat popisy umístění odpovídající regulárnímu výrazu",
    ...
    "Database triggers are set up correctly." : "Databázové spouštěče jsou nastaveny správně.",
    "Database triggers not set up; {m} mode in use." : "Databázové spouštěče nenastaveny – je využíván režim {m}.",
    "See the documentation for information on how to resolve this." : "Pokyny k řešení tohoto naleznete v dokumentaci.",
    ...
    "Some drivers (e.g. AMD and older Intel) do not support hardware accelerated rotation. You can attempt to force software-based transpose in this case." : "Některé ovladače (např. AMD nebo starší Intel) nepodporují hardwarově urychlované otáčení. V takovém případě můžete zkusit vynutit softwarové transponování.",
    ...
    "Force transpose in software" : "Vynutit transpozici v softwaru",
    ...
    "Template" : "Šablona",
    "Shared" : "Sdíleno",
    "Search your photos …" : "Hledat vaše fotky …",
    "Start typing to find photos and albums" : "Psaním vyhledávejte ve fotkách a albech",
    ...
    "Create a new face with this name?" : "Vytvořit nový obličej s tímto jménem?",
    "Create new face" : "Vytvořit nový obličej",
    ...
    "No albums selected" : "Nevybrána žádná alba",
    "Choose the destination folder for the upload" : "Zvolte cílovou složku pro nahrání",
    "Creating tags" : "Vytváření štítků",
    "Uploading {file}" : "Nahrávání {file}",
    "Failed to upload {file}" : "Nepodařilo se nahrát {file}",
    "Adding files to album {album}" : "Přidávání souborů do alba {album}",
    "Attaching tags to {file}" : "Přikládání štítků k {file}",
    "Failed to attach tags to {file}" : "Nepodařilo se připojit štítky k {file}",
    "Some files have not been uploaded." : "Některé soubory nebyly nahrány.",
    "Destination path" : "Popis umístění cíle",
    "Add to albums" : "Přidat do alb",
    "Add tags" : "Přidat štítky",
    "Attach collaborative tags to all uploads" : "Připojit štítky pro spolupráci k veškerým aktualizacím",
    "_Upload {n} file_::_Upload {n} files_" : ["Nahrát {n} soubor","Nahrát {n} soubory","Nahrát {n} souborů","Nahrát {n} soubory"],
    "Sorting order" : "Pořadí řazení",
    ...
    "Unidentified location" : "Neurčené umístění",
    "Files without location" : "Soubory bez umístění",
    "Upload not permitted" : "Nahrávání není povoleno",
    "_Skipped {n} file that already exists_::_Skipped {n} files that already exist_" : ["Přeskočen {n} soubor, který už existuje","Přeskočen {n} soubory, které už existují","Přeskočeno {n} souborů, které už existují","Přeskočen {n} soubory, které už existují"],
    "Uploading {file} ({current}/{total})" : "Nahrávání {file} ({current}/{total})",
    "Upload failed" : "Nahrání se nezdařilo",
    "_Successfully uploaded {n} file_::_Successfully uploaded {n} files_" : ["Úspěšně nahrán {n} soubor","Úspěšně nahrány {n} soubory","Úspěšně nahráno {n} souborů","Úspěšně nahrány {n} soubory"],
    "Uploaded {success} files, {failed} failed" : "Nahráno {success} souborů, {failed} se nezdařilo",
    "_Failed to upload {n} file_::_Failed to upload {n} files_" : ["Nepodařilo se nahrát {n} soubor","Nepodařilo se nahrát {n} soubory","Nepodařilo se nahrát {n} souborů","Nepodařilo se nahrát {n} soubory"],
    "Image saved successfully" : "Obrázek úspěšně uložen",
    "Error saving image: {error}" : "Chyba při ukládání obrázku: {error}",
    ...
    "Save as" : "Uložit jako",
    "Are you sure you want to discard the changes?" : "Opravdu chcete změny zahodit?",
    "Undo" : "Vrátit zpět",
    "Redo" : "Zopakovat",
    ...
    "Setup" : "Nastavení",
    "Failed to add {filename} to album." : "Nepodařilo se přidat {filename} do alba ",
    "Failed to remove {filename}." : "{filename} se nepodařilo odebrat.",
    "Failed to create {albumName}." : "Nepodařilo se vytvořit {albumName}.",
    "Failed to update properties of {albumName} with {properties}." : "Nepodařilo se zaktualizovat vlastnosti {albumName} s {properties}",
    ...
    "Failed to remove {filename} from face." : "Nepodařilo se odebrat {filename} z obličeje.",
    "Failed to move {filename} from face." : "Nepodařilo se přesunout {filename}z obličeje.",
    ...
    "Cover image set successfully" : "Obrázek na přebal úspěšně nastaven",
    "Failed to set cover image" : "Nepodařilo se nastavit obrázek na přebal",
