OC.L10N.register(
    ...
    "Info" : "Información",
    "Close" : "Zarrar",
    "{photoCount} photos" : "{photoCount} semeyes",
    ...
    "Images (JPEG, PNG, GIF, BMP)" : "Imáxenes (JPEG, PNG, GIF y BMP)",
    ...
    "Failed to delete {name}." : "Nun se pue desaniciar «{name}»",
    "Save" : "Guardar",
    ...
    "Failed to rename {oldName} to {name}." : "Nun se pue renomar «{albumName}» a «{name}».",
